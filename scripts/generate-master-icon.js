...
const svg = `
<svg width="1024" height="1024" viewBox="0 0 32 32" fill="transparent" xmlns="http://www.w3.org/2000/svg">
  <defs>
...
async function run() {
  await sharp(Buffer.from(svg))
    .png()
    .toFile('app-icon.png');
  console.log("Successfully generated app-icon.png at 1024x1024!");
}
